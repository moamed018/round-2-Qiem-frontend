...
export function AboutCard({
    ...
    return (
        <div className="group flex flex-col items-center mb-10 sm:w-90 w-80 mx-auto bg-[#D1E8E2] pt-16 pb-26 rounded-full hover:bg-linear-to-t hover:from-[#000] hover:to-[#C29062] shadow-2xl active:bg-linear-to-t active:from-[#000] active:to-[#C29062] ">
            <div className="bg-white sm:w-[280px] sm:h-[280px] w-[200px] h-[200px] rounded-full flex items-center justify-center shadow-2xl mb-10">
                <Icon className="text-[#D1E8E2] w-[80px] h-[80px] transition-all duration-200 group-hover:text-[#C29062] group-active:text-[#C29062] select-none" />
            </div>
            <h3 className="text-4xl text-gray-700 font-bold mb-4 transition-all duration-200 group-hover:text-[#C29062] group-active:text-[#C29062] px-2 select-none">
                {title}
            </h3>
            <p className="text-lg px-6 text-center group-hover:text-white group-active:text-white transition-all duration-200 select-none">
                {description}
            </p>
        </div>
    );
