...
export default function Reviewer() {
    ...
    const validationSchema = Yup.object({
        ...
        price: Yup.number(),
        idNumber: Yup.string()
            .length(14, "يجب ان يكون الرقم 14 رقم")
            .required("هذا الحقل مطلوب"),
    });
        ...
        <RegisterPage title="إنشاء حساب جديد">
            ...
            >
                ...
                <div className="flex justify-between gap-6 ">
                    <SelectMenu
                        classNameParent="grow-1"
                        title="اختر المنطقة"
                        options={options}
                        value={formik.values.region2}
                        onChange={(value) =>
                            formik.setFieldValue("region2", value)
                        }
                        onBlur={() => formik.setFieldTouched("region2", true)}
                        error={
                            formik.touched.region2 && formik.errors.region2
                                ? formik.errors.region2
                                : ""
                        }
                    />
                    ...
                    <SelectMenu
                        ...
                        title="اختر المنطقة"
                        options={options}
                        value={formik.values.region3}
                        onChange={(value) =>
                            formik.setFieldValue("region3", value)
                        }
                        onBlur={() => formik.setFieldTouched("region3", true)}
                        error={
                            formik.touched.region3 && formik.errors.region3
                                ? formik.errors.region3
                                : ""
                        }
                    />
                </div>
                ...
                <Input
                    ...
                    placeholder="إضافة بطاقة الهوية الوطنية"
                    type="number"
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    name="idNumber"
