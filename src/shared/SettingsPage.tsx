        ...
        <section className="">
            ...
            <main className="flex">
                ...
                <div className="grow flex flex-col">
                    ...
                    >
                        <button
                            className={`w-full py-8 px-8 text-start font-semibold text-2xl  bg-[#D1E8E24D] border-y border-[#8B94C6] cursor-pointer hover:bg-[#D1E8E290] transition flex justify-between items-center 
                                ${
                                    activeIndex === 0 &&
                                    "bg-linear-to-l from-[#000000] to-[#C29062] text-white pe-15"
                                }
                                `}
                            onClick={() => toggleTap(0)}
                        >
                            ...
                            <FaPen
                                className={`w-[40px] h-[40px] text-[#C29062] border-b-2 pb-1.5 border-b-[#C29062] transition ${
                                    activeIndex === 0 &&
                        ...
                        {activeIndex === 0 && (
                            <div className="p-4 text-gray-700 border-t bg-white grow">
                                <span>تعديل معلومات الملف الشخصي</span>
                            </div>
                        )}
                    </div>
                    ...
                    >
                        ...
                        {activeIndex === 1 && (
                            <div className="p-4 text-gray-700 border-t  grow">
                                <div className="border-2 border-[#D1E8E2] shadow-[0px_0px_10px_0px_#0000001A] px-4 py-8 rounded-md my-4 lg:mx-12 mx-6">
                                    ...
                                    >
                                        <div className="mb-6">
                                            ...
                                            <p className="mb-2 text-blue-900">
                                                لاغراض التجربة والتطوير فقط ادخل
                                                كلمة السر الحالية:{" "}
                                                <b>12345678</b>
                                            </p>
