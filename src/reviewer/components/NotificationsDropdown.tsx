                ...
                <div className="absolute right-0 mt-2 w-80 bg-white shadow-lg rounded-lg overflow-hidden z-50">
                    <ul className="divide-y divide-gray-200">
                        {notifications.map((notification) => (
                            <li key={notification.id} className="flex items-center p-3 hover:bg-gray-100 transition">
                                <img src={notification.image} alt="Notification" className="w-12 h-12 rounded-md object-cover" />
                                <div className="ml-3">
