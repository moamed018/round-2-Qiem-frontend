...
function PaidProjects() {
  ...
  // const [builingInfo, setBuildingInfo] = useState<BuildingInfo>(
  //   {
  ...
  //     buildingDescription:"تكون من صالة ومجلس وثلاث غرف نوم ومطبخ و ثلاث دورات مياه وتراس و مطل على الشارع  بمساحة 138م..........."
  //   }
